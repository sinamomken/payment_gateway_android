package ir.keloud.android.lib.common.utils;
...
public class Log_OC {
    ...
    private static String mKeloudDataFolderLog = "keloud_log";
    ...
    public static void setLogDataFolder(String logFolder){
    	mKeloudDataFolderLog = logFolder;
    }
    ...
    public static void startLogging() {
    	String logPath = Environment.getExternalStorageDirectory() + File.separator + 
    					mKeloudDataFolderLog + File.separator + LOG_FOLDER_NAME;
